...
async function loadConnections(rpc, profile) {
  const [config, inventory] = await Promise.all([
    rpc("config.get", { key: "provider", profile }),
    rpc("model.options", { profile })
  ]);
  const providers = (config.providers || []).map((p) => ({
    id: p.id,
    label: p.label,
    authenticated: p.authenticated === true,
    models: [...new Set((inventory.providers || []).find((row3) => row3.slug === p.id)?.models || [])]
  }));
...
function createWorkspaceTools(React2, sdk2, ctx) {
  ...
  const stack3 = { display: "grid", gap: 10 };
  const panel3 = { ...stack3, padding: 12, border: "1px solid var(--ui-stroke-secondary)", borderRadius: 8 };
  const selectStyle2 = { color: "inherit", background: "var(--ui-background)", padding: 8 };
  const field = (label, input) => h("label", { style: stack3 }, h("span", null, label), React2.cloneElement(input, { "aria-label": label }));
  ...
  function FolderPicker({ directory, onChoose, busy }) {
    ...
    return h(
      ...
      listing && h(
        "section",
        { role: "dialog", "aria-label": "\u0412\u044B\u0431\u043E\u0440 \u043F\u0430\u043F\u043A\u0438 \u043F\u0440\u043E\u0435\u043A\u0442\u0430", style: panel3 },
        ...
        h("div", { style: { ...stack3, maxHeight: 250, overflow: "auto" } }, ...listing.directories.map((entry) => h(Button2, { key: entry.path, type: "button", disabled: loading, onClick: () => browse(entry.path) }, entry.name))),
...
function createTaskControls(React2, { Button: Button2, Textarea }, ctx) {
  ...
  return function TaskControls({ task, runs, path, perform, busy }) {
    ...
    return h(
      ...
      action && h(
        "section",
        { role: "dialog", "aria-label": "\u041F\u043E\u0434\u0442\u0432\u0435\u0440\u0436\u0434\u0435\u043D\u0438\u0435 \u0438\u0437\u043C\u0435\u043D\u0435\u043D\u0438\u044F \u0437\u0430\u0434\u0430\u0447\u0438", style: panel3 },
      ...
      task.attempts?.length > 0 && h(
        ...
        ...task.attempts.map((previous) => h(
          "section",
          { key: previous.attempt, style: panel3 },
...
\u041F\u0440\u043E\u0432\u0430\u0439\u0434\u0435\u0440: ${confirmRoute.provider}`),
      ...
      task.status === "review" && !task.archived && h(
        ...
        h("label", { style: row2 }, h("input", { type: "checkbox", checked, disabled: busy || unsettled, onChange: (e) => setChecked(e.target.checked), "aria-label": "\u042F \u043E\u0442\u043A\u0440\u044B\u043B \u0444\u0430\u0439\u043B\u044B \u0438 \u043F\u0440\u043E\u0432\u0435\u0440\u0438\u043B \u043A\u0440\u0438\u0442\u0435\u0440\u0438\u0438" }), "\u042F \u043E\u0442\u043A\u0440\u044B\u043B \u0444\u0430\u0439\u043B\u044B \u0438 \u043F\u0440\u043E\u0432\u0435\u0440\u0438\u043B \u043A\u0440\u0438\u0442\u0435\u0440\u0438\u0438, \u0430 \u043D\u0435 \u0442\u043E\u043B\u044C\u043A\u043E \u043F\u0440\u043E\u0447\u0438\u0442\u0430\u043B \u043E\u0442\u0447\u0451\u0442."),
  ...
  function Project({ project, perform, actions, busy, model, provider, catalog }) {
    ...
    return h(
      ...
      h("label", { style: row2 }, h("input", { type: "checkbox", checked: showArchived, onChange: (e) => setShowArchived(e.target.checked), "aria-label": "\u041F\u043E\u043A\u0430\u0437\u0430\u0442\u044C \u0430\u0440\u0445\u0438\u0432" }), "\u041F\u043E\u043A\u0430\u0437\u0430\u0442\u044C \u0430\u0440\u0445\u0438\u0432"),
  ...
  function Workspace({ profile, gateway, epoch, connectionId }) {
    ...
    return h(
      ...
      error && h("p", { role: "alert" }, error),
      h("section", { style: panel2 }, h("strong", null, "\u041F\u0435\u0440\u0432\u044B\u0439 \u0440\u0435\u0437\u0443\u043B\u044C\u0442\u0430\u0442 \u2014 \u043F\u043E \u0448\u0430\u0433\u0430\u043C"), paragraph("1. \u0412\u044B\u0431\u0435\u0440\u0438\u0442\u0435 \u043E\u0442\u0434\u0435\u043B\u044C\u043D\u0443\u044E \u043F\u0430\u043F\u043A\u0443 \u0438 \u0441\u043E\u0437\u0434\u0430\u0439\u0442\u0435 \u043F\u0440\u043E\u0435\u043A\u0442. 2. \u0412\u044B\u0431\u0435\u0440\u0438\u0442\u0435 \u0441\u0432\u043E\u0451 \u043F\u043E\u0434\u043A\u043B\u044E\u0447\u0435\u043D\u0438\u0435 Hermes. 3. \u041E\u043F\u0438\u0448\u0438\u0442\u0435 \u0440\u0435\u0437\u0443\u043B\u044C\u0442\u0430\u0442 \u0438 \u043F\u0440\u043E\u0432\u0435\u0440\u043A\u0443 (\u0438\u043B\u0438 \u0437\u0430\u043F\u043E\u043B\u043D\u0438\u0442\u0435 \u043F\u0440\u0438\u043C\u0435\u0440). 4. \u0421\u043E\u0433\u043B\u0430\u0441\u0443\u0439\u0442\u0435 \u043F\u043B\u0430\u043D. 5. \u041F\u043E\u0434\u0442\u0432\u0435\u0440\u0434\u0438\u0442\u0435 \u0437\u0430\u043F\u0443\u0441\u043A \u0438 \u043F\u0440\u043E\u0432\u0435\u0440\u044C\u0442\u0435 \u0441\u043E\u0437\u0434\u0430\u043D\u043D\u044B\u0435 \u0444\u0430\u0439\u043B\u044B.")),
