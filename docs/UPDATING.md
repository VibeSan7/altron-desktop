...
Инструкция этой ветки относится к подготовке **0.4.0-beta.1**. До её публикации не ищите новые архивы в старом выпуске 0.3. Берите основной архив, архив обслуживания и контрольные суммы из одной проверенной сборки.
